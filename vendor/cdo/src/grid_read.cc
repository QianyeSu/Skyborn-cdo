...
static void
grid_read_data(size_t ikv, size_t nkv, std::vector<KVMap> const &kvmap, GridDesciption &grid, size_t *iproj, size_t *igmap,
               const char *dname)
{
...
static void
grid_read_mapping(size_t igmap, size_t nkv, std::vector<KVMap> const &kvmap, int gridID)
{
