...
public:
  ...
  inline static RegisterEntry<Monarith> registration = RegisterEntry<Monarith>();
  ...
  run() override
  {
    ...
    while (true)
    {
      ...
      if (yearmon1 != yearmon2)
      {
        ...
        if (numFields2 == 0) cdo_abort("Missing year=%4d mon=%2d in %s!", year1, month1, cdo_get_stream_name(1));
