...
private:
  ...
  Varray<double> ufield_v{};
  Varray<double> vfield_v{};
  Varray2D<double> urfield{};
  Varray2D<double> vrfield{};
...
public:
  ...
  init() override
  {
    ...
    grid1x = Varray<double>(gridsize);
    grid1y = Varray<double>(gridsize);
    gridux = Varray<double>(gridsize);
    griduy = Varray<double>(gridsize);
    gridvx = Varray<double>(gridsize);
    gridvy = Varray<double>(gridsize);
  ...
  run() override
  {
    ...
    urfield = Varray2D<double>(nlevs);
    vrfield = Varray2D<double>(nlevs);
