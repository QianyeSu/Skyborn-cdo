...
divdpm -divdpm \
divdpy -divdpy \
dminuteavg -dminuteavg \
dminutemax -dminutemax \
dminutemean -dminutemean \
dminutemin -dminutemin \
dminuterange -dminuterange \
dminutestd -dminutestd \
dminutestd1 -dminutestd1 \
dminutesum -dminutesum \
dminutevar -dminutevar \
dminutevar1 -dminutevar1 \
...
gh2hlx -gh2hlx \
gheight -gheight \
gheight_full -gheight_full \
gheight_half -gheight_half \
